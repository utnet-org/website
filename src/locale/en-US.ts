...
export default {
  ...
  footer: {
    ...
    Utility_Foundation: "Utility Foundation",
    Activity: "Activity",
    Provider: "Provider",
    Chips: "Chips",
    About: "About",
  ...
  home: {
    ...
    The_computing_power:
      "The High-performance container cloud makes it easy for vendors to become professional cloud service providers. power provider in the Utility network.",
    ...
    Help_Utility_open:
      "Help Utility open source community to build a revolutionary application Web3",
    ...
    Developers: "Developers",
    Developers_text1: "Bring your project idea to multiple users on Utility Ecosystem.",
    ...
    Computing_power_renter_text1: "Rent high-performance computing power from utility providers for your own purpose.",
    Join_Ecosystem: "Join Ecosystem",
    Mining: "Mining",
    Check_Wallet: "Check Wallet",
    Rent: "Rent",
    Utility_Ecosystem: "Utility Ecosystem",
  ...
  learning_center: {
    ...
    using_UtilityNet: 'To many people, using UtilityNet means many things. Maybe you want to log into an app, prove your identity online, or transfer some UNC or other cryptographic tokens. First you need an account. The easiest way to create and access an account is to use the Utility crypto wallet’s decentralized application.',
    Utility_digital_wallet: "Utility digital wallet",
    The_Utility_digital_wallet: "The Utility digital wallet is the credentials you need to prove your identity and access on-chain.",
    ...
    Utility_block_explorer: 'Utility block explorer',
    ...
    Utility_Development_Kit: 'Utility Development Kit ',
    ...
    Learn_how_to_mine_and: "Learn how to mine and rent in the Utility network.",
  ...
  utilityNetwork: {
    ...
    decentralized_computing_service_platform_text:
      "Utility Network may be a platform built through blockchain technology, dedicated to building a decentralized computing service infrastructure. This means that computing resources are no longer dependent on a single centralized service provider, but are distributed across multiple nodes in the network.",
    ...
    computing_resources_and_data_management_text:
      "Utility Networks may provide a mechanism to enable users to access and leverage distributed computing resources. This includes services such as computing power management, task distribution, data storage and retrieval.",
    blockchain_technology: "Blockchain technology",
    blockchain_technology_text:
      "The Utility Network may use blockchain to record and verify computing tasks, resource transactions, data transfers, and more. The immutable and distributed nature of blockchain contributes to the transparency and security of the system.",
    economic_model: "Economic model",
    economic_model_text:
      "The Utility Network may have a token-based or cryptocurrency-based economic model that incentivizes nodes in the network to provide computing services. This could include mining mechanisms, token rewards, Gas fees, and more.",
    ...
    vajra_age_first_text:
      "The second epoch, the Vajra Age, will mark the launch of the Testnet Utility and the announcement of the incentive program.The focus during this period was on rewarding early computing miners, who were the first miners to be rewarded when the network went live. This is also the core group of network maintenance.",
    ...
    golem_age_first_text:
      "The Golem Age, a Tertiary phase, will see the Mainnet Utility come online.",
    ...
    maria_age_first_text:
      "The Maria Age is the fourth era of the development of Utility networks.During this period, the network will welcome the training and operation of the largest parametric models made by humans.",
