...
import headerImage from '@/assets/images/ai_icon.png';
import wallet_img1 from '@/assets/images/ai_img1.png';
import wallet_img2 from '@/assets/images/ai_img2.png';
import { ref } from 'vue';
const headerTitle = 'AI模型';
